...
const JsonValidator = require('@sap/approuter/lib/utils/JsonValidator');
const fsUtils = require('@sap/approuter/lib/utils/fs-utils');
const businessServiceUtils = require('@sap/approuter/lib/utils/business-service-utils');
const xsAppSchema = require('@sap/approuter/lib/configuration/schemas/xs-app-schema.json');
const hostPatternSchema = require('@sap/approuter/lib/configuration/schemas/refs/host-pattern-schema.json');
const sourceSchema = require('@sap/approuter/lib/configuration/schemas/refs/source-schema.json');
const scopesSchema = require('@sap/approuter/lib/configuration/schemas/refs/scopes-schema.json');
const cookiesSchema = require('@sap/approuter/lib/configuration/schemas/cookies-schema.json');
const pluginsSchema = require('@sap/approuter/lib/configuration/schemas/plugins-schema.json');
const headersSchema = require('@sap/approuter/lib/configuration/schemas/headers-schema.json');
const whitelistSchema = require('@sap/approuter/lib/configuration/schemas/whitelist-schema.json');
const environmentSchema = require('@sap/approuter/lib/configuration/schemas/environment-schema.json');
const envDestinationsSchema = require('@sap/approuter/lib/configuration/schemas/environment-destinations-schema.json');
const serviceDestinationsSchema = require('@sap/approuter/lib/configuration/schemas/service-destinations-schema.json');
const destinationsSchema = require('@sap/approuter/lib/configuration/schemas/destinations-schema.json');
const approuterOptionsSchema = require('@sap/approuter/lib/configuration/schemas/options-schema.json');
const uaaOptionsSchema = require('@sap/approuter/lib/configuration/schemas/uaa-config-schema.json');
const iasOptionsSchema = require('@sap/approuter/lib/configuration/schemas/ias-config-schema.json');
const corsSchema = require('@sap/approuter/lib/configuration/schemas/refs/cors-schema.json');
const connectivitySchema = require('@sap/approuter/lib/configuration/schemas/connectivity-config-schema.json');
const html5RepoCredSchema = require('@sap/approuter/lib/configuration/schemas/html5-repo-credentials-schema.json');
const businessServiceSchema = require('@sap/approuter/lib/configuration/schemas/business-service-credentials-schema.json');
const extSessionMgtSchema = require('@sap/approuter/lib/configuration/schemas/ext-session-mgt-schema.json');
const zoneInfoSchema = require('@sap/approuter/lib/configuration/schemas/zone-info-schema.json');
const sessionContextInputSchema = require('@sap/approuter/lib/configuration/schemas/session-context-input-schema.json');
const destinationUtils = require('@sap/approuter/lib/utils/destination-utils');
const vcapUtils = require('@sap/approuter/lib/utils/vcap-utils');
const urlSchema = require('@sap/approuter/lib/configuration/schemas/url-schema.json');
const circuitBreakerConfSchema = require('@sap/approuter/lib/configuration/schemas/circuit-breaker-conf-schema.json');
let regexErr;
