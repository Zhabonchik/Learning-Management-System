...
const applicationConfig = require('@sap/approuter/lib/configuration/app-config');
const configurationUtils = require('@sap/approuter/lib/utils/configuration-utils');
const environment = require('@sap/approuter/lib/environment');
const environmentConfig = require('@sap/approuter/lib/configuration/env-config');
const uaaConfiguration = require('@sap/approuter/lib/configuration/uaa-config');
const iasConfiguration = require('@sap/approuter/lib/configuration/ias-config');
const validators = require('@sap/approuter/lib/configuration/validators');
...
module.exports.load = function(options) {
  ...
  iasConfig && !uaaConfig && (iasConfig.iasOnly = true);
