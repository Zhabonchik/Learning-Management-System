...
var fs = require('fs');
var serviceFilter = require('@sap/xsenv/lib/filter');
const readCFServices = require('@sap/xsenv/lib/cfservice').readCFServices;
const readK8SServices = require('@sap/xsenv/lib/k8sservice').readK8SServices;
const readServiceBindingServices = require('@sap/xsenv/lib/serviceBindingService').readServiceBindingServices;
const redactServicesSecretData = require('@sap/xsenv/lib/redactServiceData').redactServicesSecretData;
