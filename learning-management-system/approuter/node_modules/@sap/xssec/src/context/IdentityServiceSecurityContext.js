const ConfigurationError = require("@sap/xssec/src/error/configuration/ConfigurationError");
const SecurityContext = require("@sap/xssec/src/context/SecurityContext");

/**
 * @typedef {import('@sap/xssec/src/service/IdentityService')} IdentityService
 * @typedef {import('@sap/xssec/src/token/IdentityServiceToken')} IdentityServiceToken
 */
