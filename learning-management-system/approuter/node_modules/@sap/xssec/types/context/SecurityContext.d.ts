...
/**
 * @typedef {import('@sap/xssec/types/service/Service')} Service
 * @typedef {import('@sap/xssec/types/token/Token')} Token
 * @typedef {import('@sap/xssec/types/util/Types').SecurityContextConfig} SecurityContextConfig
 */
/**
 * @template {Service} S - The type of the service.
 * @template {Token} T - The type of the token.
 */
declare class SecurityContext<S extends Service, T extends Token> {
    /**
     ...
     */
    static buildContextConfig(contextConfig: SecurityContextConfig): void;
    /**
     ...
     */
    constructor(service: S, token: T, contextConfig: SecurityContextConfig);
...
declare namespace SecurityContext {
    export { Service, Token, SecurityContextConfig };
}
type Service = import("@sap/xssec/types/service/Service");
type Token = import("@sap/xssec/types/token/Token");
type SecurityContextConfig = import("@sap/xssec/types/util/Types").SecurityContextConfig;
