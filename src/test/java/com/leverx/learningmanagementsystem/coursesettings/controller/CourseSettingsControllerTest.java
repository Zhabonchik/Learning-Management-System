...
import com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils;
...
import static com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils.COURSE_SETTINGS;
import static com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils.EXISTING_COURSE_SETTINGS_END_DATE;
import static com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils.EXISTING_COURSE_SETTINGS_ID;
import static com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils.EXISTING_COURSE_SETTINGS_START_DATE;
import static com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils.NEW_COURSE_SETTINGS_END_DATE;
import static com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils.NEW_COURSE_SETTINGS_START_DATE;
import static com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils.NON_EXISTING_COURSE_SETTINGS_ID;
import static com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils.NUMBER_OF_COURSE_SETTINGS_FIELDS;
import static com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils.TOTAL_NUMBER_OF_COURSE_SETTINGS;
import static com.leverx.learningmanagementsystem.testutils.CourseSettingsTestUtils.formatter;
...
public class CourseSettingsControllerTest {
    ...
    void getAll_shouldReturnAllCourseSettingsAnd200() throws Exception {
        ...
        response.andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(TOTAL_NUMBER_OF_COURSE_SETTINGS));
    }
